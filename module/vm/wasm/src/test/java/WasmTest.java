...
import expanse.vm.wasm.instance.GasModule;
import expanse.vm.wasm.instance.Module;
import expanse.vm.wasm.nav.function.NativeInstance;
import org.junit.jupiter.api.Test;
import util.FileReader;
import util.GasMapping;
...
//        System.out.println("---------");
        ...
        Module.newModule(readByName("ch13_prime.wasm", config), config).invoke("main");
        GasModule m = GasModule.newModule(readByName("ch13_prime.wasm", config), config, GasMapping.TEST).limit(10000000000L);
        m.invoke("main");
        System.out.println("---------");
        System.out.println("gas fee: " + m.getGasCount());
        System.out.println("---------");
