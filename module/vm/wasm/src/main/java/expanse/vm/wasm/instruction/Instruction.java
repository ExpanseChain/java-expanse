...
import expanse.vm.wasm.instruction.control.*;
import expanse.vm.wasm.instruction.memory.*;
import expanse.vm.wasm.instruction.numeric.*;
import expanse.vm.wasm.instruction.numeric.i32.I32Const;
import expanse.vm.wasm.instruction.numeric.i32.compare.*;
import expanse.vm.wasm.instruction.numeric.i32.operate.*;
import expanse.vm.wasm.instruction.numeric.i64.I64Const;
import expanse.vm.wasm.instruction.numeric.i64.compare.*;
import expanse.vm.wasm.instruction.numeric.i64.operate.*;
import expanse.vm.wasm.instruction.parametric.Drop;
import expanse.vm.wasm.instruction.parametric.Select;
import expanse.vm.wasm.instruction.parametric.SelectC;
import expanse.vm.wasm.instruction.reference.RefFunc;
import expanse.vm.wasm.instruction.reference.RefIsNull;
import expanse.vm.wasm.instruction.reference.RefNull;
import expanse.vm.wasm.instruction.table.*;
import expanse.vm.wasm.instruction.variable.*;
...
import might.vm.wasm.instruction.numeric.i32.compare.*;
import might.vm.wasm.instruction.numeric.i32.operate.*;
import might.vm.wasm.instruction.numeric.i64.compare.*;
import might.vm.wasm.instruction.numeric.i64.operate.*;
...
public enum Instruction {
    ...
    public void operate(ModuleInstance mi, Dump args) {
        Assertions.requireNonNull(operate);
