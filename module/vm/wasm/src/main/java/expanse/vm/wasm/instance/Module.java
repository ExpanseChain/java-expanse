...
import expanse.vm.wasm.core.*;
import expanse.vm.wasm.core.structure.*;
...
import expanse.vm.wasm.model.index.*;
...
import expanse.vm.wasm.error.instance.InstanceException;
...
public class Module implements ModuleInstance {
    ...
    public Module(ModuleInfo moduleInfo, ModuleConfig config) {
        this.moduleInfo = moduleInfo;

        this.linkImports(config);
