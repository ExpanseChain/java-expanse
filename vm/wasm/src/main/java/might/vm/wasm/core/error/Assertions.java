package might.vm.wasm.core.error;

import might.vm.wasm.core.error.assertion.AssertionTrueException;
import might.vm.wasm.core.error.assertion.AssertionTypeException;
